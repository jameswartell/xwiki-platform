...
public class TestUtils
{
     ...
     * @since 5.0M2
     */
    public static final TestCredentials ADMIN_CREDENTIALS = new TestCredentials("Admin", "admin");

    /**
     * @since 5.1M1
     */
    public static final TestCredentials SUPER_ADMIN_CREDENTIALS = new TestCredentials("superadmin", "pass");
    ...
    private TestCredentials defaultCredentials;
    ...
    {
        setDefaultCredentials(new TestCredentials(username, password));
    }

    /**
     * @since 7.0RC1
     */
    public TestCredentials setDefaultCredentials(TestCredentials defaultCredentials)
    {
        TestCredentials currentCredentials = getDefaultCredentials();
    ...
    public TestCredentials getDefaultCredentials()
    {
        return this.defaultCredentials;
    }

    public HttpClientContext getHttpClientContext(ClassicHttpRequest request)
    {
        ...
        return ContextBuilder.create()
            .preemptiveBasicAuth(new HttpHost(uri.getScheme(), uri.getHost(), uri.getPort()),
                new UsernamePasswordCredentials(this.defaultCredentials.getUserName(),
    ...
    {
        return getURLToLoginAs(SUPER_ADMIN_CREDENTIALS.getUserName(), String.valueOf(SUPER_ADMIN_CREDENTIALS.getUserName()));
    }
    ...
    {
        return getURLToLoginAndGotoPage(ADMIN_CREDENTIALS.getUserName(), String.valueOf(ADMIN_CREDENTIALS.getPassword()),
            pageURL);
    }
     ...
     */
    public ViewPage createPageWithAttachment(String space, String page, String content, String title, String syntaxId,
        String parentFullPageName, String attachmentName, InputStream attachmentData, TestCredentials credentials)
        throws Exception
    {
     ...
     */
    public ViewPage createPageWithAttachment(String space, String page, String content, String title,
        String attachmentName, InputStream attachmentData, TestCredentials credentials) throws Exception
    {
    ...
    {
        return this.httpClient.execute(request, getHttpClientContext(request));
    }
